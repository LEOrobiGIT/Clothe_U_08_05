    ...
    <!--<div class="swiper new-arrival">
        <div class="swiper-wrapper2">
            <div class="swiper-slide box">
                <img src="../Clothe-u_Finale/images/new6.webp" alt="">
                <div class="content">
                    <a href="#" class="btn">Noleggia</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                <img src="../Clothe-u_Finale/images/new4.webp" alt="">
                <div class="content">
                    <a href="#" class="btn">Noleggia</a>
                </div>
            </div>
            ...
            <div class="swiper-slide box">
                <img src="../Clothe-u_Finale/images/new5.webp" alt="">
                <div class="content">
                    <a href="#" class="btn">Noleggia</a>
                </div>
            </div>
...
<script>
    ...
    $('.box_servizi').each(function() {
    var elemPos = $(this).offset().top;
    var elemHeight = $(this).outerHeight();
    var winHeight = $(window).height();
    var winScroll = $(window).scrollTop();

    if (winScroll > elemPos - winHeight + elemHeight && winScroll < elemPos + elemHeight) {
      $(this).fadeIn();
    } else {
      $(this).fadeOut();
    }
...
<script>
    var $win = $(window);
    var $stat = $('.box_servizi'); // Change this to affect your desired element.
